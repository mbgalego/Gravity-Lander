...
export const SHIPS: ShipModelConfig[] = [
  ...
  // =========================================================================
  {
    ...
    localPoints: {
      nose: { x: 0, y: -53.0 },
      leftShoulder: { x: -39.6, y: 24.0 },
      rightShoulder: { x: 39.6, y: 24.0 },
      leftHip: { x: -24.0, y: 30.0 },
      rightHip: { x: 24.0, y: 30.0 },
      leftFoot: { x: -24.0, y: 42.0 },
      rightFoot: { x: 24.0, y: 42.0 },
      leftThrusterPos: { x: -10.5, y: 33.6 },
      rightThrusterPos: { x: 10.5, y: 33.6 },
    },
    stats: {
      agility: 5,
      fuelTank: 3,
