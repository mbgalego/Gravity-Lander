...
export const OFFICIAL_LUNA_MAP: CustomMapData = {
  ...
  textNotes: [
    {
      id: 'note-luna-tutorial-sticker',
      x: 459,
      y: 720,
      text: '★ TUTORIAL WORLD ★\nFlight Training & Controls Academy',
      size: 'xl',
      style: 'monospace',
      color: '#fbbf24',
      showBorder: true,
 ...
 * e.g. when a user edits Luna, Titan, Ares, Vesta, Phobos, Europa, Ceres, Glacies, Vespera, Calypso, Zephyr, or Tartarus and saves it.
 */
...
/**
 * Checks whether a map ID refers to an official campaign planet (Luna, Titan, Ares, Vesta, Phobos, Europa, Ceres, Glacies, Vespera, Calypso, Zephyr, Tartarus).
...
export function isOfficialMap(mapId: string): boolean {
  ...
  return ['luna', 'titan', 'ares', 'vesta', 'phobos', 'europa', 'ceres', 'glacies', 'vespera', 'calypso', 'zephyr', 'tartarus'].includes(cleanId);
}
