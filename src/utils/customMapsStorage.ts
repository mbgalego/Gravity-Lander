...
export const OFFICIAL_PROMETHEAN_MAP: CustomMapData = {
  id: 'official-promethean',
  ...
  author: 'Planetary Federation',
  createdAt: 1788079314977,
  updatedAt: 1789596054171,
  themeId: 'custom',
  terrainLineStyle: 'straight',
  customTheme: {
    id: 'theme-promethean',
    name: 'Promethean Core Atmosphere',
    skyTop: '#190a02',
    skyBottom: '#321404',
    terrainFill: '#291003',
  ...
  obstacles: [
      ...
      {
        id: 'obs-pasted-1789594262736',
        name: 'SPIRE Layer (Copy)',
        type: 'spire',
        points: [
            { x: 10326, y: 1764 },
            { x: 10336, y: 1868 },
      ...
      {
        id: 'obs-pasted-1789595823114',
        name: 'SPIRE Layer (Copy) (Copy)',
        type: 'spire',
        points: [
            { x: 2644, y: 454 },
            { x: 2678, y: 454 },
  ...
  fuelPickups: [
      { id: 'fuel-luna-1', x: 2644, y: 1880, amount: 75 },
      { id: 'fuel-luna-2', x: 6248, y: 388, amount: 65 },
      { id: 'fuel-luna-3', x: 3056, y: 1150, amount: 75 },
      { id: 'fuel-1789594697291', x: 416, y: 1218, amount: 100 },
      { id: 'fuel-1789594917279', x: 4528, y: 548, amount: 100 },
      { id: 'fuel-1789594938821', x: 5124, y: 954, amount: 100 },
      { id: 'fuel-1789595282856', x: 6709, y: 1878, amount: 100 },
      { id: 'fuel-1789595293771', x: 9780, y: 1256, amount: 100 },
      { id: 'fuel-1789595301009', x: 11562, y: 1350, amount: 100 },
      { id: 'fuel-1789596039703', x: 7553, y: 1010, amount: 100 },
  ],
  cargoPlatforms: [
      { id: 'cargo-pickup-58213', type: 'pickup', label: 'MAGNETIC DYNAMO ASSEMBLY RIG', x: 3602, y: 2876, width: 280, cargoType: 'standard', truckCount: 0 },
      { id: 'vehicle-depot-58213', type: 'vehicle_depot', label: 'SURFACE VEHICLE & ROVER LOGISTICS BASE', x: 2769, y: 817, width: 480, truckCount: 2 },
      { id: 'cargo-pickup-1789594044533', type: 'pickup', x: 1068, y: 1899, width: 140, weightClass: 'heavy', cargoType: 'explosive', label: 'HIGH-EXPLOSIVE MUNITIONS DEPOT' },
      { id: 'vehicle-depot-1789594176441', type: 'vehicle_depot', x: 5821, y: 2823, width: 480, label: 'SURFACE VEHICLE & ROVER LOGISTICS BASE', truckCount: 2 },
      { id: 'cargo-pickup-1789594665807', type: 'pickup', x: 997, y: 798, width: 140, weightClass: 'medium', cargoType: 'plasma', label: 'PLASMA BATTERY RECHARGE HUB' },
  ],
  signposts: [
  ...
  volcanoes: [
      { id: 'volcano-1788089815821', x: 13086, y: 2374, width: 380, height: 240, calderaWidth: 122, eruptionHeight: 480, eruptionInterval: 10, eruptionDuration: 1.8, colorTheme: 'magma' },
      { id: 'volcano-1788089890698', x: 8293, y: 1363, width: 180, height: 110, calderaWidth: 58, eruptionHeight: 220, eruptionInterval: 6, eruptionDuration: 1.8, colorTheme: 'magma' },
      { id: 'volcano-1788096286953', x: 7753, y: 1099, width: 260, height: 160, calderaWidth: 83, eruptionHeight: 320, eruptionInterval: 10, eruptionDuration: 1.8, colorTheme: 'magma' },
