...
export const OFFICIAL_PROMETHEAN_MAP: CustomMapData = {
  ...
  fuelPickups: [
    { id: "fuel-luna-1", x: 3000, y: 506, amount: 75 },
    { id: "fuel-luna-2", x: 6248, y: 388, amount: 65 },
    { id: "fuel-luna-3", x: 3100, y: 1480, amount: 75 },
  ],
  cargoPlatforms: [
    {
      id: "cargo-pickup-58213",
      type: "pickup",
      label: "MAGNETIC DYNAMO ASSEMBLY RIG",
      x: 3602,
      y: 2876,
      width: 280,
      cargoType: "standard",
  ...
  volcanoes: [
    ...
    { id: "volcano-1788089890698", x: 8293, y: 1363, width: 180, height: 110, calderaWidth: 58, eruptionHeight: 220, eruptionInterval: 10, eruptionDuration: 1.8, colorTheme: "magma" },
    ...
    { id: "volcano-1788119447821", x: 3083, y: 2951, width: 260, height: 160, calderaWidth: 83, eruptionHeight: 320, eruptionInterval: 10, eruptionDuration: 1.8, colorTheme: "magma" },
  ],
};
