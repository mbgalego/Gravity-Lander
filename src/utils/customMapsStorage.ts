 ...
 * e.g. when a user edits Luna, Titan, Ares, Vesta, Phobos, Europa, Ceres, Glacies, Vespera, Calypso, or Zephyr and saves it.
 */
...
/**
 * Checks whether a map ID refers to an official campaign planet (Luna, Titan, Ares, Vesta, Phobos, Europa, Ceres, Glacies, Vespera, Calypso, Zephyr).
...
export function isOfficialMap(mapId: string): boolean {
  ...
  return ['luna', 'titan', 'ares', 'vesta', 'phobos', 'europa', 'ceres', 'glacies', 'vespera', 'calypso', 'zephyr'].includes(cleanId);
}
